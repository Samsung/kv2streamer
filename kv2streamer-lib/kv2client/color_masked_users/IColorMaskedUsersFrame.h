 ...
 * 
 * @brief This file contains IColorMaskedUsersFrame class definition.
 * 
 */
...
public:
	...
	/**
	 * Destructor of IColorMaskedUsersFrame.
	 * 
	 * @remarks More importantly, notifies the ColorMaskedUsersFrameStreamer that this frame has been deleted.
	...
	~IColorMaskedUsersFrame();

private:
	friend class ColorMaskedUsersFrameStreamer;
	IColorMaskedUsersFrame(ColorMaskedUsersFrameStreamerPtr streamer);
	
private:
	ColorMaskedUsersFrameStreamerPtr streamer;
	
	unsigned char* frameBufferReference;
	unsigned char** GetColorMaskedUsersFrameBufferReferencePtr();
};
